...
public class ViewBinaryTreeRight {
	...
	int visibleNodes(Node root) {
		...
		while(queue.size()>0){
			...
			if (node.right!=null) queue.offerLast(node.right);		// Just change the order to have right node added first
